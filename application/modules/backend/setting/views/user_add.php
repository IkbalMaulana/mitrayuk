					...
					<div class="row"> 
						<div class="col-lg-12"> 
							<form class="form-horizontal" role="form" method="post" action="<?= base_url(getModule().'/'.getController().'/save') ?>">
								...
								<input type="hidden" name="temp_user" class="form-control" value="<?php echo (@$getMember) ? @$getMember[0]['usernameUser'] : @$temp_user ?>">
								...
								<?php echo input_email_group('emailUser','Email',(@$getMember[0]['emailUser']) ? @$getMember[0]['emailUser'] : set_value('emailUser'),'','required') ?>
