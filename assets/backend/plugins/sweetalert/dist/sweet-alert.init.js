...
!function($) {
    ...
    var base_url = window.location.origin + "/react/private/";
    ...
    $('.delete-user').click(function(e){
        ...
        swal({   
            ...
            $.ajax(
            {
             ...
             type: "post",
             url: BASEURL+module+"/"+controller+"/delete/"+parent,
             data: parent,
             success: function(data){
             }
         })
    ...
    $('.delete-gallery').click(function(e){
        ...
        swal({   
            ...
            $.ajax(
            {
             ...
             type: "post",
             url: BASEURL+module+"/"+controller+"/delete_gallery/"+parent,
             data: parent,
             success: function(data){
             }
         })
    ...
    $(document).on('click', '.del-dialog', function() {
        ...
        if (route) {
            ...
            route = BASEURL+module+"/"+controller+"/delete/"+parent;
        }
    ...
    $('.delete-combination').click(function(e){
        ...
        swal({   
            ...
            $.ajax(
            {
             ...
             type: "post",
             url: BASEURL+module+"/"+controller+"/delete_combination/"+parent,
             data: parent,
             success: function(data){
             }
         })
    ...
    $('.main-photo').click(function(e){
        ...
        swal({   
            ...
            $.ajax(
            {
             ...
             type: "post",
             url: BASEURL+module+"/"+controller+"/main_photo/"+parent,
             data: parent,
             success: function(data){
             }
         })
    ...
    $('.delete-attribute').click(function(e){
        ...
        swal({   
            ...
            $.ajax(
            {
             ...
             type: "post",
             url: BASEURL+"/catalog/attributes/delete/"+parent,
             data: parent,
             success: function(data){
             }
         })
